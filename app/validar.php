...
//	require("nav.php")
		?>
	<div class="container">
	<h1><div> Ingresa tu codigo de Verificacion</div></h1>
<form name="form" method="GET" action="verificar_codigo.php">
   Codigo:
<?php	
...
<input type="submit" name="enviar" value="Verificar Codigo">
